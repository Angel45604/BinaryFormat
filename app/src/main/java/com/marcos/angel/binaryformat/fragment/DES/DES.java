...
public class DES {
    ...
    /**
     *
     * @param bits The 32bits String to process
     * @return The String processed by each S-Box
     */
    public String sBlock(String bits) {
        ...
        for(int i=0 ; i < 8 ; i++) {
            ...
            int row[] = new int [2];
            //row[0] = bits[6*i];
            row[0]=Integer.parseInt(bits.substring(6*i,(6*i)+1));
            //row[1] = bits[(6*i)+5];
            row[1]=Integer.parseInt(bits.substring((6*i)+5,(6*i)+6));
            ...
            //column[2] = bits[(6*i)+3];
            //column[3] = bits[(6*i)+4];
            column[0] = Integer.parseInt(bits.substring((6*i)+1,(6*i)+2));
            column[0] = Integer.parseInt(bits.substring((6*i)+2,(6*i)+3));
            column[0] = Integer.parseInt(bits.substring((6*i)+3,(6*i)+4));
            column[0] = Integer.parseInt(bits.substring((6*i)+4,(6*i)+5));
